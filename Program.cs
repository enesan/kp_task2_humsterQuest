...
Console.WriteLine("Добро пожаловать, игрок. Постарайся выжить в этой занимательной игре.");
...
if (lose_pts == 1)
{
    Console.WriteLine("Ты был слишком слаб. Game over.");
}
else
{
    Console.WriteLine("Позддравляем, вы прошли игру!");
}